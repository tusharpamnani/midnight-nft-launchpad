    ...
    try {
        switch (command) {
            ...
            case 'create-collection': {
                ...
                if (!name || !description || isNaN(maxSupply))
                    throw new Error("usage: create-collection <name> <description> <maxSupply>");
            ...
            case 'mint-from-collection': {
                ...
                if (!address || !metadata)
                    throw new Error("usage: mint-from-collection <address> <metadata>");
