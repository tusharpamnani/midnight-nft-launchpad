...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      mint: (...args_1) => {
        ...
        const metadataHash_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('mint',
                                     'argument 1 (as invoked from Typescript)',
                                     'collection.compact line 32 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(metadataHash_0),
        ...
        const result_0 = this._mint_0(context, partialProofData, metadataHash_0);
      ...
      transfer: (...args_1) => {
        ...
        const tokenMetaHash_0 = args_1[3];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('transfer',
                                     'argument 1 (as invoked from Typescript)',
                                     'collection.compact line 47 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        if (!(tokenMetaHash_0.buffer instanceof ArrayBuffer && tokenMetaHash_0.BYTES_PER_ELEMENT === 1 && tokenMetaHash_0.length === 32)) {
          __compactRuntime.typeError('transfer',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(tokenId_0).concat(_descriptor_1.toValue(newOwner_0).concat(_descriptor_1.toValue(tokenMetaHash_0))),
      ...
      verifyOwnership: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        const tokenId_0 = args_1[1];
        const tokenMetaHash_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('verifyOwnership',
                                     'argument 1 (as invoked from Typescript)',
                                     'collection.compact line 64 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(tokenId_0) === 'bigint' && tokenId_0 >= 0n && tokenId_0 <= 18446744073709551615n)) {
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(tokenId_0).concat(_descriptor_1.toValue(tokenMetaHash_0)),
  ...
  initialState(...args_0) {
    ...
    const desc_0 = args_0[2];
    const cap_0 = args_0[3];
    ...
    if (!(name_0.buffer instanceof ArrayBuffer && name_0.BYTES_PER_ELEMENT === 1 && name_0.length === 32)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 1 (argument 2 as invoked from Typescript)',
                                 'collection.compact line 23 char 1',
                                 'Bytes<32>',
                                 name_0)
    }
    if (!(desc_0.buffer instanceof ArrayBuffer && desc_0.BYTES_PER_ELEMENT === 1 && desc_0.length === 64)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 2 (argument 3 as invoked from Typescript)',
                                 'collection.compact line 23 char 1',
                                 'Bytes<64>',
    ...
    if (!(typeof(cap_0) === 'bigint' && cap_0 >= 0n && cap_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('Contract state constructor',
                                 'argument 3 (argument 4 as invoked from Typescript)',
                                 'collection.compact line 23 char 1',
                                 'Uint<0..18446744073709551616>',
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_8.toValue(1n),
                                                                                              alignment: _descriptor_8.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(new Uint8Array(64)),
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_8.toValue(1n),
                                                                                              alignment: _descriptor_8.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(desc_0),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_8.toValue(3n),
                                                                                              alignment: _descriptor_8.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(cap_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_0 = this._callerAddress_0(context, partialProofData);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
  ...
  _callerAddress_0(context, partialProofData) {
    ...
    if (!(result_0.buffer instanceof ArrayBuffer && result_0.BYTES_PER_ELEMENT === 1 && result_0.length === 32)) {
      __compactRuntime.typeError('callerAddress',
                                 'return value',
                                 'collection.compact line 16 char 1',
                                 'Bytes<32>',
                                 result_0)
    }
  ...
  _hashTokenData_0(owner_0, metadataHash_0) {
    return this._persistentHash_0([owner_0, metadataHash_0]);
  }
  _mint_0(context, partialProofData, metadataHash_0) {
    ...
    const commitment_0 = this._hashTokenData_0(caller_0, metadataHash_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('collection.compact line 43 char 28: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                  })(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               partialProofData,
    ...
    const tmp_1 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('collection.compact line 44 char 28: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                  })(tokenId_0 + 1n);
    __compactRuntime.queryLedgerState(context,
  ...
  _transfer_0(context, partialProofData, tokenId_0, newOwner_0, tokenMetaHash_0)
  {
    const caller_0 = this._callerAddress_0(context, partialProofData);
    const expectedCommitment_0 = this._hashTokenData_0(caller_0, tokenMetaHash_0);
                                                                                                ...
                                                                                                path: [
                                                                                                       { tag: 'value',
                                                                                                         value: { value: _descriptor_8.toValue(6n),
                                                                                                                  alignment: _descriptor_8.alignment() } }] } },
                                                                                       { push: { storage: false,
                                                                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(pubTokenId_0),
                                                                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                                                                       'member',
                                                                                       { popeq: { cached: true,
                                                                                                  result: undefined } }]).value),
                            'Token does not exist');
    const currentCommitment_0 = _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                          partialProofData,
                                                                                          [
                                                                                           { dup: { n: 0 } },
                                                                                           { idx: { cached: false,
                                                                                           ...
                                                                                           { popeq: { cached: false,
                                                                                                      result: undefined } }]).value);
    __compactRuntime.assert(this._equal_0(currentCommitment_0,
                                          expectedCommitment_0),
                            'Not the owner or invalid metadata');
    const nextCommitment_0 = this._hashTokenData_0(newOwner_0, tokenMetaHash_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
                                       ...
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(pubTokenId_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(nextCommitment_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    return [];
  }
  _verifyOwnership_0(context, partialProofData, tokenId_0, tokenMetaHash_0) {
    const caller_0 = this._callerAddress_0(context, partialProofData);
    const expectedCommitment_0 = this._hashTokenData_0(caller_0, tokenMetaHash_0);
    const pubTokenId_0 = tokenId_0;
    __compactRuntime.assert(_descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
    ...
    const currentCommitment_0 = _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                          ...
                                                                                          [
                                                                                           ...
                                                                                           { popeq: { cached: false,
                                                                                                      result: undefined } }]).value);
    __compactRuntime.assert(this._equal_1(currentCommitment_0,
                                          expectedCommitment_0),
                            'Not the owner or invalid metadata');
    return [];
  }
      ...
      member(...args_0) {
        ...
        if (!(typeof(key_0) === 'bigint' && key_0 >= 0n && key_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'collection.compact line 13 char 1',
                                     'Uint<0..18446744073709551616>',
                                     key_0)
        }
        return _descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
